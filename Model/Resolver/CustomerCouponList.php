...
use MageINIC\CouponList\Model\CouponList;
...
/**
 * Get coupon list for the customer
 */
class CustomerCouponList implements ResolverInterface
{
    /**
    ...
    public function resolve(Field $field, $context, ResolveInfo $info, array $value = null, array $args = null)
    {
        ...
        try {
            ...
            $collection = $this->couponList->get($cart->getId());
            $postData = ["items" => []];
